...
$hxClasses["BranchNinja"] = BranchNinja;
BranchNinja.__name__ = true;
BranchNinja.prototype = {
	player: null
	,shuriken: null
	,explosion: null
	,bug: null
	,create: function() {
		...
		this.shuriken = new Shuriken(100,10);
		this.explosion = new Explosion();
		this.bug = new Bug();
		this.bug.x = 350;
		this.explosion.x = 200;
		kha2d_Scene.get_the().setBackgroundColor(kha__$Color_Color_$Impl_$.Green);
		kha2d_Scene.get_the().addHero(this.player);
		kha2d_Scene.get_the().addEnemy(this.bug);
		kha2d_Scene.get_the().addProjectile(this.shuriken);
	}
	,shot: function() {
		kha2d_Scene.get_the().addProjectile(new Shuriken(0,10));
	}
	,update: function() {
	...
	,render: function(framebuffer) {
		...
		g.begin();
		kha2d_Scene.get_the().render(g);
		g.end();
	}
	,__class__: BranchNinja
};
...
kha2d_Sprite.prototype = {
	...
	,render: function(g) {
		if(this.image != null && this.visible) {
			...
			if(this.angle != 0) g.pushTransformation((function($this) {
				var $r;
				var _this = g.transformations[g.transformations.length - 1];
				var m__00 = 1;
				var m__10 = 0;
				var m__20 = $this.x + $this.originX;
				var m__01 = 0;
				var m__11 = 1;
				var m__21 = $this.y + $this.originY;
				var m__02 = 0;
				var m__12 = 0;
				var m__22 = 1;
...
var Bug = function() {
	kha2d_Sprite.call(this,kha_Assets.images.bug,36,36);
	this.walk = kha2d_Animation.createRange(0,3,5);
	this.setAnimation(this.walk);
};
$hxClasses["Bug"] = Bug;
Bug.__name__ = true;
Bug.__super__ = kha2d_Sprite;
Bug.prototype = $extend(kha2d_Sprite.prototype,{
	walk: null
	,hitWithShot: function() {
		haxe_Log.trace("I was hit",{ fileName : "Bug.hx", lineNumber : 28, className : "Bug", methodName : "hitWithShot"});
		kha2d_Scene.get_the().removeEnemy(this);
	}
	,__class__: Bug
});
...
var Explosion = function() {
	kha2d_Sprite.call(this,kha_Assets.images.explosion,36,36);
	this.explode = kha2d_Animation.createRange(0,5,4);
	this.setAnimation(this.explode);
};
$hxClasses["Explosion"] = Explosion;
Explosion.__name__ = true;
Explosion.__super__ = kha2d_Sprite;
Explosion.prototype = $extend(kha2d_Sprite.prototype,{
	explode: null
	,update: function() {
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Branch Ninja", width : 800, height : 480},function() {
		new BranchNinja();
	});
};
Math.__name__ = true;
var Player = function() {
	kha2d_Sprite.call(this,kha_Assets.images.ninjaBlack2,36,36);
	Player.instance = this;
	this.walk = kha2d_Animation.createRange(12,15,5);
	this.jump = kha2d_Animation.create(17);
	this.shoot = kha2d_Animation.create(23);
	this.setAnimation(this.walk);
};
...
Player.__super__ = kha2d_Sprite;
Player.prototype = $extend(kha2d_Sprite.prototype,{
	walk: null
	,jump: null
	,shoot: null
	,update: function() {
...
var Shuriken = function(x,y) {
	kha2d_Sprite.call(this,kha_Assets.images.shuriken,26,26,0);
	this.x = x;
	this.y = y;
	this.speedx = 20;
	this.accy = 0;
...
$hxClasses["Shuriken"] = Shuriken;
Shuriken.__name__ = true;
Shuriken.__super__ = kha2d_Sprite;
Shuriken.prototype = $extend(kha2d_Sprite.prototype,{
	hit: function(sprite) {
		haxe_Log.trace("a bug",{ fileName : "Shuriken.hx", lineNumber : 29, className : "Shuriken", methodName : "hit"});
		if(js_Boot.__instanceof(sprite,Bug)) {
			kha2d_Scene.get_the().removeProjectile(this);
			(js_Boot.__cast(sprite , Bug)).hitWithShot();
		}
	}
	,outOfView: function() {
		this.x = 0;
...
var kha_ImageList = function() {
	this.shurikenDescription = { files : ["shuriken.png"], original_height : 26, type : "image", original_width : 26, name : "shuriken"};
	this.shurikenName = "shuriken";
	this.shuriken = null;
	this.ninjaGreenDescription = { files : ["ninjaGreen.png"], original_height : 112, type : "image", original_width : 64, name : "ninjaGreen"};
	this.ninjaGreenName = "ninjaGreen";
	this.ninjaGreen = null;
	this.ninjaBlackBigDescription = { files : ["ninjaBlackBig.png"], original_height : 336, type : "image", original_width : 192, name : "ninjaBlackBig"};
	this.ninjaBlackBigName = "ninjaBlackBig";
	this.ninjaBlackBig = null;
	this.ninjaBlack2Description = { files : ["ninjaBlack2.png"], original_height : 252, type : "image", original_width : 144, name : "ninjaBlack2"};
	this.ninjaBlack2Name = "ninjaBlack2";
	this.ninjaBlack2 = null;
	this.ninjaBlackDescription = { files : ["ninjaBlack.png"], original_height : 252, type : "image", original_width : 144, name : "ninjaBlack"};
	this.ninjaBlackName = "ninjaBlack";
	this.ninjaBlack = null;
	this.greenFaceDescription = { files : ["greenFace.png"], original_height : 38, type : "image", original_width : 38, name : "greenFace"};
	this.greenFaceName = "greenFace";
	this.greenFace = null;
	this.fireballDescription = { files : ["fireball.png"], original_height : 9, type : "image", original_width : 13, name : "fireball"};
	this.fireballName = "fireball";
	this.fireball = null;
	this.explosionDescription = { files : ["explosion.png"], original_height : 36, type : "image", original_width : 216, name : "explosion"};
	this.explosionName = "explosion";
	this.explosion = null;
	this.bugDescription = { files : ["bug.png"], original_height : 36, type : "image", original_width : 144, name : "bug"};
	this.bugName = "bug";
	this.bug = null;
	this.blackFaceDescription = { files : ["blackFace.png"], original_height : 38, type : "image", original_width : 38, name : "blackFace"};
	this.blackFaceName = "blackFace";
	this.blackFace = null;
};
...
kha_ImageList.prototype = {
	blackFace: null
	,blackFaceName: null
	,blackFaceDescription: null
	,blackFaceLoad: function(done) {
		kha_Assets.loadImage("blackFace",function(image) {
			done();
		});
	}
	,blackFaceUnload: function() {
		this.blackFace.unload();
		this.blackFace = null;
	}
	,bug: null
	,bugName: null
	,bugDescription: null
	,bugLoad: function(done) {
		kha_Assets.loadImage("bug",function(image) {
			done();
		});
	}
	,bugUnload: function() {
	...
	,fireballLoad: function(done) {
		kha_Assets.loadImage("fireball",function(image) {
			done();
		});
	}
	,fireballUnload: function() {
		this.fireball.unload();
		this.fireball = null;
	}
	,greenFace: null
	,greenFaceName: null
	,greenFaceDescription: null
	,greenFaceLoad: function(done) {
		kha_Assets.loadImage("greenFace",function(image) {
			done();
		});
	}
	,greenFaceUnload: function() {
		this.greenFace.unload();
		this.greenFace = null;
	}
	,ninjaBlack: null
	,ninjaBlackName: null
	,ninjaBlackDescription: null
	,ninjaBlackLoad: function(done) {
		kha_Assets.loadImage("ninjaBlack",function(image) {
			done();
		});
	}
	,ninjaBlackUnload: function() {
		this.ninjaBlack.unload();
		this.ninjaBlack = null;
	}
	,ninjaBlack2: null
	,ninjaBlack2Name: null
	,ninjaBlack2Description: null
	,ninjaBlack2Load: function(done) {
		kha_Assets.loadImage("ninjaBlack2",function(image) {
			done();
		});
	}
	,ninjaBlack2Unload: function() {
		this.ninjaBlack2.unload();
		this.ninjaBlack2 = null;
	}
	,ninjaBlackBig: null
	,ninjaBlackBigName: null
	,ninjaBlackBigDescription: null
	,ninjaBlackBigLoad: function(done) {
		kha_Assets.loadImage("ninjaBlackBig",function(image) {
			done();
		});
	}
	,ninjaBlackBigUnload: function() {
		this.ninjaBlackBig.unload();
		this.ninjaBlackBig = null;
	}
	,ninjaGreen: null
	,ninjaGreenName: null
	,ninjaGreenDescription: null
	,ninjaGreenLoad: function(done) {
		kha_Assets.loadImage("ninjaGreen",function(image) {
			done();
		});
	}
	,ninjaGreenUnload: function() {
		this.ninjaGreen.unload();
		this.ninjaGreen = null;
	}
	,shuriken: null
	,shurikenName: null
	,shurikenDescription: null
	,shurikenLoad: function(done) {
		kha_Assets.loadImage("shuriken",function(image) {
			done();
		});
	}
	,shurikenUnload: function() {
		this.shuriken.unload();
		this.shuriken = null;
	}
		...
		while(true) {
			...
			if(e2 > -dy) {
				...
				if(this.map.collides(sprite)) {
					...
					sprite.y += 1;
					sprite.x -= sx;
					if(sx < 0) sprite.hitFrom(kha2d_Direction.RIGHT); else sprite.hitFrom(kha2d_Direction.LEFT);
					while(true) {
						if(y0 == y1) {
							sprite.y = yend;
							return;
						...
						if(this.map.collides(sprite)) {
							sprite.y -= sy;
							if(sy < 0) sprite.hitFrom(kha2d_Direction.DOWN); else sprite.hitFrom(kha2d_Direction.UP);
							return;
						}
					}
					return;
...
kha2d_Scene.get_the = function() {
	if(kha2d_Scene.instance == null) kha2d_Scene.instance = new kha2d_Scene();
...
kha2d_Scene.prototype = {
	...
	,set_camx: function(newcamx) {
		...
		if(this.collisionLayer != null) {
			this.screenOffsetX = Std["int"](Math.min(Math.max(0,this.camx - this.width / 2),this.collisionLayer.getMap().getWidth() * this.collisionLayer.getMap().getTileset().TILE_WIDTH - this.width));
			if(this.getWidth() < this.width) this.screenOffsetX = 0;
	...
	,set_camy: function(newcamy) {
		this.camy = newcamy;
		if(this.collisionLayer != null) {
			this.screenOffsetY = Std["int"](Math.min(Math.max(0,this.camy - this.height / 2),this.collisionLayer.getMap().getHeight() * this.collisionLayer.getMap().getTileset().TILE_HEIGHT - this.height));
			if(this.getHeight() < this.height) this.screenOffsetY = 0;
	...
	,update: function() {
		this.cleanSprites();
		if(this.collisionLayer != null) this.collisionLayer.advance(this.screenOffsetX,this.screenOffsetX + this.width);
		this.cleanSprites();
		var _g = 0;
		var _g1 = this.sprites;
		while(_g < _g1.length) {
	...
	,render: function(g) {
		g.set_transformation(new kha_math_FastMatrix3(1,0,0,0,1,0,0,0,1));
		...
		while(_g1 < _g) {
			...
			g.set_transformation((function($this) {
				...
				$r = new kha_math_FastMatrix3(1,0,x,0,1,y,0,0,1);
				return $r;
			}(this)));
		...
		g.set_transformation(new kha_math_FastMatrix3(1,0,-this.screenOffsetX,0,1,-this.screenOffsetY,0,0,1));
		...
		while(_g2 < 10) {
			...
			while(i1 < this.sprites.length) {
				if(this.sprites[i1].x > this.screenOffsetX + this.width) break;
		...
		while(_g11 < _g3) {
			...
			g.set_transformation((function($this) {
				...
				$r = new kha_math_FastMatrix3(1,0,x1,0,1,y1,0,0,1);
				return $r;
			}(this)));
...
var kha2d_Tileset = function(image,tileWidth,tileHeight,tiles) {
	...
	this.xmax = Std["int"](image.get_width() / this.TILE_WIDTH);
	this.ymax = Std["int"](image.get_height() / this.TILE_HEIGHT);
	if(tiles == null) {
		this.tiles = [];
		var _g1 = 0;
