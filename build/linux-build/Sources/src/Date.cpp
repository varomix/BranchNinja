...
{
HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Date.hx",26,0xf8e3cb31)
HX_STACK_THIS(this)
...
::Date Date_obj::fromTime( Float t){
	HX_STACK_FRAME("Date","fromTime",0x44fd3cb7,"Date.fromTime","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Date.hx",57,0xf8e3cb31)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(58)
	::Date result = ::Date_obj::__new((int)0,(int)0,(int)0,(int)0,(int)0,(int)0);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(59)
	Float tmp = (t * ((Float)0.001));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(59)
	result->mSeconds = tmp;
	HX_STACK_LINE(60)
	::Date tmp1 = result;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(60)
	return tmp1;
}
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_FRAME("Date","fromString",0x5ead97fb,"Date.fromString","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Date.hx",64,0xf8e3cb31)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(64)
	...
	switch( (int)(tmp)){
		case (int)8: {
			HX_STACK_LINE(66)
			Array< ::String > tmp1 = s.split(HX_HCSTRING(":","\x3a","\x00","\x00","\x00"));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(66)
			Array< ::String > k = tmp1;		HX_STACK_VAR(k,"k");
			HX_STACK_LINE(67)
			::String tmp2 = k->__get((int)0);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(67)
			Dynamic tmp3 = ::Std_obj::parseInt(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(67)
			::String tmp4 = k->__get((int)1);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(67)
			...
			HX_STACK_LINE(67)
			::Date tmp8 = ::Date_obj::__new((int)0,(int)0,(int)0,tmp3,tmp5,tmp7);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(67)
			::Date d = tmp8;		HX_STACK_VAR(d,"d");
			HX_STACK_LINE(68)
			::Date tmp9 = d;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(68)
			return tmp9;
		}
		;break;
		case (int)10: {
			HX_STACK_LINE(70)
			Array< ::String > tmp1 = s.split(HX_HCSTRING("-","\x2d","\x00","\x00","\x00"));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(70)
			Array< ::String > k = tmp1;		HX_STACK_VAR(k,"k");
			HX_STACK_LINE(71)
			::String tmp2 = k->__get((int)0);		HX_STACK_VAR(tmp2,"tmp2");
			...
			HX_STACK_LINE(71)
			::String tmp7 = k->__get((int)2);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(71)
			Dynamic tmp8 = ::Std_obj::parseInt(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(71)
			::Date tmp9 = ::Date_obj::__new(tmp3,tmp6,tmp8,(int)0,(int)0,(int)0);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(71)
			return tmp9;
		}
		;break;
		case (int)19: {
			HX_STACK_LINE(73)
			Array< ::String > tmp1 = s.split(HX_HCSTRING(" ","\x20","\x00","\x00","\x00"));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(73)
			Array< ::String > k = tmp1;		HX_STACK_VAR(k,"k");
			HX_STACK_LINE(74)
			::String tmp2 = k->__get((int)0);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(74)
			Array< ::String > tmp3 = tmp2.split(HX_HCSTRING("-","\x2d","\x00","\x00","\x00"));		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(74)
			Array< ::String > y = tmp3;		HX_STACK_VAR(y,"y");
			HX_STACK_LINE(75)
			::String tmp4 = k->__get((int)1);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(75)
			Array< ::String > tmp5 = tmp4.split(HX_HCSTRING(":","\x3a","\x00","\x00","\x00"));		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(75)
			Array< ::String > t = tmp5;		HX_STACK_VAR(t,"t");
			HX_STACK_LINE(76)
			::String tmp6 = y->__get((int)0);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(76)
			Dynamic tmp7 = ::Std_obj::parseInt(tmp6);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(76)
			::String tmp8 = y->__get((int)1);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(76)
			Dynamic tmp9 = ::Std_obj::parseInt(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(76)
			int tmp10 = (tmp9 - (int)1);		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(76)
			::String tmp11 = y->__get((int)2);		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(76)
			Dynamic tmp12 = ::Std_obj::parseInt(tmp11);		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(77)
			::String tmp13 = t->__get((int)0);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(77)
			Dynamic tmp14 = ::Std_obj::parseInt(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(77)
			::String tmp15 = t->__get((int)1);		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(77)
			Dynamic tmp16 = ::Std_obj::parseInt(tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(77)
			::String tmp17 = t->__get((int)2);		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(77)
			Dynamic tmp18 = ::Std_obj::parseInt(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(76)
			::Date tmp19 = ::Date_obj::__new(tmp7,tmp10,tmp12,tmp14,tmp16,tmp18);		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(76)
			return tmp19;
		}
		;break;
