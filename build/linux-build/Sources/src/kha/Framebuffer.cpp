...
Void Framebuffer_obj::__construct(int windowId,::kha::graphics1::Graphics g1,::kha::graphics2::Graphics g2,::kha::graphics4::Graphics g4)
{
...
hx::ObjectPtr< Framebuffer_obj > Framebuffer_obj::__new(int windowId,::kha::graphics1::Graphics g1,::kha::graphics2::Graphics g2,::kha::graphics4::Graphics g4)
{  hx::ObjectPtr< Framebuffer_obj > _result_ = new Framebuffer_obj();
	_result_->__construct(windowId,g1,g2,g4);
	return _result_;}
...
::kha::graphics1::Graphics Framebuffer_obj::get_g1( ){
	HX_STACK_FRAME("kha.Framebuffer","get_g1",0x01ba3cbe,"kha.Framebuffer.get_g1","kha/Framebuffer.hx",38,0x5860e4dc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(39)
...
::kha::graphics2::Graphics Framebuffer_obj::get_g2( ){
	HX_STACK_FRAME("kha.Framebuffer","get_g2",0x01ba3cbf,"kha.Framebuffer.get_g2","kha/Framebuffer.hx",48,0x5860e4dc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(49)
...
::kha::graphics4::Graphics Framebuffer_obj::get_g4( ){
	HX_STACK_FRAME("kha.Framebuffer","get_g4",0x01ba3cc1,"kha.Framebuffer.get_g4","kha/Framebuffer.hx",58,0x5860e4dc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(59)
...
int Framebuffer_obj::get_width( ){
	HX_STACK_FRAME("kha.Framebuffer","get_width",0xd0a34fb2,"kha.Framebuffer.get_width","kha/Framebuffer.hx",67,0x5860e4dc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(68)
	int tmp = this->windowId;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(68)
	int tmp1 = ::kha::System_obj::windowWidth(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(68)
	return tmp1;
}
...
int Framebuffer_obj::get_height( ){
	HX_STACK_FRAME("kha.Framebuffer","get_height",0x7491e4bb,"kha.Framebuffer.get_height","kha/Framebuffer.hx",76,0x5860e4dc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(77)
	int tmp = this->windowId;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(77)
	int tmp1 = ::kha::System_obj::windowHeight(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(77)
	return tmp1;
}
