...
{
		HX_STACK_FRAME("kha.input.Keyboard","sendDownEvent",0xd04ca677,"kha.input.Keyboard.sendDownEvent","kha/input/Keyboard.hx",47,0xb57e4ba7)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("kha.input.Keyboard","sendUpEvent",0xd43edc1e,"kha.input.Keyboard.sendUpEvent","kha/input/Keyboard.hx",57,0xb57e4ba7)
		HX_STACK_THIS(this)
		HX_STACK_ARG(key,"key")
		HX_STACK_ARG(_char,"char")
		HX_STACK_LINE(57)
	...
	HX_STACK_ARG(num,"num")
{
		...
		HX_STACK_LINE(10)
		::kha::input::Keyboard tmp1 = ::kha::SystemImpl_obj::getKeyboard(tmp);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(10)
		return tmp1;
	}
}
