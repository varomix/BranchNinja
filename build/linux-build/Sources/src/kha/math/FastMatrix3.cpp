...
::kha::math::FastMatrix3 FastMatrix3_obj::fromMatrix3( ::kha::math::Matrix3 m){
	HX_STACK_FRAME("kha.math.FastMatrix3","fromMatrix3",0x0d42cb74,"kha.math.FastMatrix3.fromMatrix3","kha/math/FastMatrix3.hx",19,0xadedc804)
	HX_STACK_ARG(m,"m")
	HX_STACK_LINE(20)
	::kha::math::FastMatrix3 tmp = ::kha::math::FastMatrix3_obj::__new(m->_00,m->_10,m->_20,m->_01,m->_11,m->_21,m->_02,m->_12,m->_22);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(20)
	return tmp;
}
