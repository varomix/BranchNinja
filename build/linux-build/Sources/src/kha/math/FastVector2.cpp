...
::cpp::Float32 FastVector2_obj::get_length( ){
	HX_STACK_FRAME("kha.math.FastVector2","get_length",0x0ff9a926,"kha.math.FastVector2.get_length","kha/math/FastVector2.hx",17,0x343674e7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(18)
...
::kha::math::FastVector2 FastVector2_obj::fromVector2( ::kha::math::Vector2 v){
	HX_STACK_FRAME("kha.math.FastVector2","fromVector2",0x4fc2a16e,"kha.math.FastVector2.fromVector2","kha/math/FastVector2.hx",9,0x343674e7)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(10)
	::kha::math::FastVector2 tmp = ::kha::math::FastVector2_obj::__new(v->x,v->y);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(10)
	return tmp;
}
