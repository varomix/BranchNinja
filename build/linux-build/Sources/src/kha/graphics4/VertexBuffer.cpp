...
{
		HX_STACK_FRAME("kha.graphics4.VertexBuffer","init",0x67d0082b,"kha.graphics4.VertexBuffer.init","kha/graphics4/VertexBuffer.hx",48,0x9edcaa69)
		HX_STACK_THIS(this)
		HX_STACK_ARG(vertexCount,"vertexCount")
		HX_STACK_ARG(structure,"structure")
...
{
		HX_STACK_FRAME("kha.graphics4.VertexBuffer","lock",0x69cc6906,"kha.graphics4.VertexBuffer.lock","kha/graphics4/VertexBuffer.hx",57,0x9edcaa69)
		HX_STACK_THIS(this)
...
buffer->unlock();
{
		HX_STACK_FRAME("kha.graphics4.VertexBuffer","unlock",0xd0432c9f,"kha.graphics4.VertexBuffer.unlock","kha/graphics4/VertexBuffer.hx",62,0x9edcaa69)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("kha.graphics4.VertexBuffer","stride",0x7be6a9f4,"kha.graphics4.VertexBuffer.stride","kha/graphics4/VertexBuffer.hx",68,0x9edcaa69)
		HX_STACK_THIS(this)
		HX_STACK_LINE(68)
		return (int)0;
	}
...
return buffer->count();
{
		HX_STACK_FRAME("kha.graphics4.VertexBuffer","count",0xfa81ef54,"kha.graphics4.VertexBuffer.count","kha/graphics4/VertexBuffer.hx",73,0x9edcaa69)
		HX_STACK_THIS(this)
		HX_STACK_LINE(73)
		return (int)0;
	}
