...
{
	if (inName==HX_HCSTRING("DEPTH16","\x88","\x92","\x1e","\xea")) return 3;
...
Dynamic TextureFormat_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_HCSTRING("RGBA64","\xf2","\x5c","\x88","\xd6")) return RGBA64;
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("DEPTH16","\x88","\x92","\x1e","\xea"),
	HX_HCSTRING("RGBA64","\xf2","\x5c","\x88","\xd6"),
	::String(null()) };
...
{
hx::Static(DEPTH16) = hx::CreateEnum< TextureFormat_obj >(HX_HCSTRING("DEPTH16","\x88","\x92","\x1e","\xea"),3);
...
hx::Static(RGBA64) = hx::CreateEnum< TextureFormat_obj >(HX_HCSTRING("RGBA64","\xf2","\x5c","\x88","\xd6"),4);
}
