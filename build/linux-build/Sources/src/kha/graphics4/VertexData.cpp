...
int VertexData_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_HCSTRING("Float4x4","\xf4","\x3d","\x29","\xb7")) return 4;
...
int VertexData_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_HCSTRING("Float4x4","\xf4","\x3d","\x29","\xb7")) return 0;
...
Dynamic VertexData_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_HCSTRING("Float4x4","\xf4","\x3d","\x29","\xb7")) return Float4x4;
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("Float4x4","\xf4","\x3d","\x29","\xb7"),
	::String(null()) };
...
hx::Static(Float4x4) = hx::CreateEnum< VertexData_obj >(HX_HCSTRING("Float4x4","\xf4","\x3d","\x29","\xb7"),4);
}
