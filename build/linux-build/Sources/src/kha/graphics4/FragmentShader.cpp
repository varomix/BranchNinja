...
HX_STACK_ARG(source,"source")
{
	...
	{
		HX_STACK_LINE(15)
		::cpp::Function< Void ( ::kha::graphics4::FragmentShader ) > inFinalizer = ::cpp::Function< Void ( ::kha::graphics4::FragmentShader shader)>(hx::AnyCast(&::kha::graphics4::FragmentShader_obj::destroy) );		HX_STACK_VAR(inFinalizer,"inFinalizer");
		HX_STACK_LINE(15)
...
{
		HX_STACK_FRAME("kha.graphics4.FragmentShader","initFragmentShader",0x6c01cdef,"kha.graphics4.FragmentShader.initFragmentShader","kha/graphics4/FragmentShader.hx",25,0xa52f2538)
		HX_STACK_THIS(this)
		HX_STACK_ARG(source,"source")
	}
return null();
...
{
		HX_STACK_FRAME("kha.graphics4.FragmentShader","unused",0xe53eb5c0,"kha.graphics4.FragmentShader.unused","kha/graphics4/FragmentShader.hx",29,0xa52f2538)
		HX_STACK_THIS(this)
		HX_STACK_LINE(30)
...
void FragmentShader_obj::destroy( ::kha::graphics4::FragmentShader shader){
{
		HX_STACK_FRAME("kha.graphics4.FragmentShader","destroy",0x2f632510,"kha.graphics4.FragmentShader.destroy","kha/graphics4/FragmentShader.hx",19,0xa52f2538)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FragmentShader_obj,destroy,(void))
