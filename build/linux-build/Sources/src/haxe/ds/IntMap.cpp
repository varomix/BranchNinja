...
{
HX_STACK_FRAME("haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",53,0x6252ca1b)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",56,0x6252ca1b)
		HX_STACK_THIS(this)
...
Dynamic IntMap_obj::get( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",59,0x6252ca1b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(60)
...
bool IntMap_obj::exists( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/haxe/ds/IntMap.hx",63,0x6252ca1b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(64)
