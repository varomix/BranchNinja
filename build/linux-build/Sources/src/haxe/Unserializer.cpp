...
{
HX_STACK_FRAME("haxe.Unserializer","new",0xa8f5e205,"haxe.Unserializer.new","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",99,0xe71d5f2a)
HX_STACK_THIS(this)
HX_STACK_ARG(buf,"buf")
{
	...
	this->cache = tmp1;
	HX_STACK_LINE(108)
	Dynamic tmp2 = ::haxe::Unserializer_obj::DEFAULT_RESOLVER;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(108)
	...
	HX_STACK_LINE(113)
	Dynamic tmp4 = r;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(113)
	this->setResolver(tmp4);
}
;
	return null();
}
...
{
		HX_STACK_FRAME("haxe.Unserializer","setResolver",0x5545046d,"haxe.Unserializer.setResolver","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",124,0xe71d5f2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(r,"r")
		HX_STACK_LINE(125)
		...
		if ((tmp)){
			struct _Function_2_1{
				inline static Dynamic Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",126,0xe71d5f2a)
					{
						...
						::hx::Class run(::String _){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",127,0xe71d5f2a)
							HX_STACK_ARG(_,"_")
							{
								HX_STACK_LINE(127)
								return null();
						...
						int __ArgCount() const { return 1; }
						::Enum run(::String _){
							HX_STACK_FRAME("*","_Function_3_2",0x520271ba,"*._Function_3_2","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",128,0xe71d5f2a)
							HX_STACK_ARG(_,"_")
							{
								HX_STACK_LINE(128)
								return null();
...
int Unserializer_obj::readDigits( ){
	HX_STACK_FRAME("haxe.Unserializer","readDigits",0x75598b17,"haxe.Unserializer.readDigits","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",147,0xe71d5f2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(148)
...
Float Unserializer_obj::readFloat( ){
	HX_STACK_FRAME("haxe.Unserializer","readFloat",0x5bd86dcb,"haxe.Unserializer.readFloat","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",172,0xe71d5f2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(173)
	int tmp = this->pos;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(173)
...
{
		HX_STACK_FRAME("haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",185,0xe71d5f2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(o,"o")
		HX_STACK_LINE(186)
		while((true)){
...
Dynamic Unserializer_obj::unserializeEnum( ::Enum edecl,::String tag){
	HX_STACK_FRAME("haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",200,0xe71d5f2a)
	HX_STACK_THIS(this)
	...
	::String tmp5 = tag;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(209)
	cpp::ArrayBase tmp6 = args;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(209)
	Dynamic tmp7 = ::Type_obj::createEnum(tmp4,tmp5,tmp6);		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(209)
	return tmp7;
}
...
Dynamic Unserializer_obj::unserialize( ){
	HX_STACK_FRAME("haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",232,0xe71d5f2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(233)
	{
		HX_STACK_LINE(233)
		...
		switch( (int)(tmp1)){
			...
			case (int)121: {
				...
				s = tmp12;
				HX_STACK_LINE(253)
				Array< ::String > tmp13 = this->scache;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(253)
			...
			case (int)97: {
				...
				HX_STACK_LINE(264)
				cpp::ArrayBase tmp3 = this->cache;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(264)
				...
				while((true)){
					...
					HX_STACK_LINE(267)
					bool tmp8 = (c == (int)104);		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(267)
					if ((tmp8)){
						HX_STACK_LINE(268)
						(this->pos)++;
					...
					HX_STACK_LINE(271)
					bool tmp9 = (c == (int)117);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(271)
					if ((tmp9)){
						HX_STACK_LINE(272)
						(this->pos)++;
						HX_STACK_LINE(273)
						int tmp10 = this->readDigits();		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(273)
						int n = tmp10;		HX_STACK_VAR(n,"n");
						HX_STACK_LINE(274)
						cpp::ArrayBase tmp11 = a;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(274)
						int tmp12 = (a->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ) + n);		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(274)
						int tmp13 = (tmp12 - (int)1);		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(274)
						hx::IndexRef((tmp11).mPtr,tmp13) = null();
					}
					else{
						HX_STACK_LINE(276)
						Dynamic tmp10 = this->unserialize();		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(276)
						a->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp10);
					}
				}
				HX_STACK_LINE(278)
				cpp::ArrayBase tmp5 = a;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(278)
				return tmp5;
			}
			;break;
			case (int)111: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",280,0xe71d5f2a)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							return __result;
						}
			...
			case (int)114: {
				...
				if ((tmp4)){
					...
					HX_STACK_LINE(286)
					cpp::ArrayBase tmp7 = this->cache;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(286)
					cpp::ArrayBase tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(286)
					int tmp9 = tmp8->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic );		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(286)
					tmp5 = (tmp6 >= tmp9);
				}
				else{
				...
				HX_STACK_LINE(288)
				cpp::ArrayBase tmp6 = this->cache;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(288)
			...
			case (int)82: {
				...
				if ((tmp4)){
					...
					int tmp6 = n;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(291)
					Array< ::String > tmp7 = this->scache;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(291)
				...
				HX_STACK_LINE(293)
				Array< ::String > tmp6 = this->scache;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(293)
				int tmp7 = n;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(293)
				::String tmp8 = tmp6->__get(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(293)
				return tmp8;
			}
			;break;
			...
			case (int)99: {
				...
				HX_STACK_LINE(302)
				cpp::ArrayBase tmp9 = this->cache;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(302)
				Dynamic tmp10 = o;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(302)
				tmp9->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp10);
				HX_STACK_LINE(303)
				Dynamic tmp11 = o;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(303)
				this->unserializeObject(tmp11);
				HX_STACK_LINE(304)
				Dynamic tmp12 = o;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(304)
				return tmp12;
			...
			case (int)119: {
				...
				HX_STACK_LINE(311)
				cpp::ArrayBase tmp10 = this->cache;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(311)
				Dynamic tmp11 = e;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(311)
				tmp10->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp11);
				HX_STACK_LINE(312)
			...
			case (int)106: {
				...
				HX_STACK_LINE(320)
				Array< ::String > tmp9 = ::Type_obj::getEnumConstructs(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(320)
				int tmp10 = index;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(320)
				::String tmp11 = tmp9->__get(tmp10);		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(320)
				::String tag = tmp11;		HX_STACK_VAR(tag,"tag");
				HX_STACK_LINE(321)
				bool tmp12 = (tag == null());		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(321)
				if ((tmp12)){
					HX_STACK_LINE(322)
					::String tmp13 = (HX_HCSTRING("Unknown enum index ","\x57","\xca","\x63","\x30") + name);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(322)
					::String tmp14 = (tmp13 + HX_HCSTRING("@","\x40","\x00","\x00","\x00"));		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(322)
				...
				HX_STACK_LINE(323)
				::Enum tmp13 = edecl;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(323)
				::String tmp14 = tag;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(323)
				Dynamic tmp15 = this->unserializeEnum(tmp13,tmp14);		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(323)
				Dynamic e = tmp15;		HX_STACK_VAR(e,"e");
				HX_STACK_LINE(324)
				cpp::ArrayBase tmp16 = this->cache;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(324)
				Dynamic tmp17 = e;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(324)
				tmp16->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp17);
				HX_STACK_LINE(325)
				Dynamic tmp18 = e;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(325)
				return tmp18;
			}
			;break;
			case (int)108: {
				...
				HX_STACK_LINE(328)
				cpp::ArrayBase tmp2 = this->cache;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(328)
			...
			case (int)118: {
				...
				HX_STACK_LINE(380)
				cpp::ArrayBase tmp21 = this->cache;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(380)
				::Date tmp22 = d;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(380)
				tmp21->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp22);
				HX_STACK_LINE(381)
				::Date tmp23 = d;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(381)
				return tmp23;
			}
			;break;
			case (int)115: {
				...
				HX_STACK_LINE(390)
				Array< int > tmp8 = ::haxe::Unserializer_obj::CODES;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(390)
				Array< int > codes = tmp8;		HX_STACK_VAR(codes,"codes");
				HX_STACK_LINE(391)
				bool tmp9 = (codes == null());		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(391)
				if ((tmp9)){
					HX_STACK_LINE(392)
					Array< int > tmp10 = ::haxe::Unserializer_obj::initCodes();		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(392)
					codes = tmp10;
					HX_STACK_LINE(393)
				...
				HX_STACK_LINE(396)
				int tmp11 = (int(len) & int((int)3));		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(396)
				int rest = tmp11;		HX_STACK_VAR(rest,"rest");
				HX_STACK_LINE(397)
				int tmp12 = (int(len) >> int((int)2));		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(397)
				int tmp13 = (tmp12 * (int)3);		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(397)
				bool tmp14 = (rest >= (int)2);		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(397)
				...
				HX_STACK_LINE(397)
				int size = tmp16;		HX_STACK_VAR(size,"size");
				HX_STACK_LINE(398)
				int tmp17 = i;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(398)
				int tmp18 = (len - rest);		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(398)
				int tmp19 = (tmp17 + tmp18);		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(398)
				int max = tmp19;		HX_STACK_VAR(max,"max");
				HX_STACK_LINE(399)
				int tmp20 = size;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(399)
				::haxe::io::Bytes tmp21 = ::haxe::io::Bytes_obj::alloc(tmp20);		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(399)
				::haxe::io::Bytes bytes = tmp21;		HX_STACK_VAR(bytes,"bytes");
				HX_STACK_LINE(400)
				int bpos = (int)0;		HX_STACK_VAR(bpos,"bpos");
				HX_STACK_LINE(401)
				while((true)){
					HX_STACK_LINE(401)
					bool tmp22 = (i < max);		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(401)
					...
					HX_STACK_LINE(402)
					Array< int > tmp24 = codes;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(402)
					...
					HX_STACK_LINE(403)
					Array< int > tmp27 = codes;		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(403)
					...
					HX_STACK_LINE(403)
					{
						...
						HX_STACK_LINE(403)
						int index = tmp29;		HX_STACK_VAR(index,"index");
						HX_STACK_LINE(403)
					...
					HX_STACK_LINE(403)
					int c2 = tmp29;		HX_STACK_VAR(c2,"c2");
					HX_STACK_LINE(404)
					{
						HX_STACK_LINE(404)
						int tmp30 = (bpos)++;		HX_STACK_VAR(tmp30,"tmp30");
						HX_STACK_LINE(404)
						int pos = tmp30;		HX_STACK_VAR(pos,"pos");
						HX_STACK_LINE(404)
						int tmp31 = (int(c1) << int((int)2));		HX_STACK_VAR(tmp31,"tmp31");
						HX_STACK_LINE(404)
						int tmp32 = (int(c2) >> int((int)4));		HX_STACK_VAR(tmp32,"tmp32");
						HX_STACK_LINE(404)
					...
					HX_STACK_LINE(405)
					Array< int > tmp30 = codes;		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(405)
					...
					HX_STACK_LINE(405)
					{
						...
						HX_STACK_LINE(405)
						int index = tmp32;		HX_STACK_VAR(index,"index");
						HX_STACK_LINE(405)
					...
					HX_STACK_LINE(405)
					int tmp32 = tmp30->__get(tmp31);		HX_STACK_VAR(tmp32,"tmp32");
					HX_STACK_LINE(405)
					int c3 = tmp32;		HX_STACK_VAR(c3,"c3");
					HX_STACK_LINE(406)
					{
						HX_STACK_LINE(406)
						int tmp33 = (bpos)++;		HX_STACK_VAR(tmp33,"tmp33");
						HX_STACK_LINE(406)
						int pos = tmp33;		HX_STACK_VAR(pos,"pos");
						HX_STACK_LINE(406)
						int tmp34 = (int(c2) << int((int)4));		HX_STACK_VAR(tmp34,"tmp34");
						HX_STACK_LINE(406)
						int tmp35 = (int(c3) >> int((int)2));		HX_STACK_VAR(tmp35,"tmp35");
						HX_STACK_LINE(406)
					...
					HX_STACK_LINE(407)
					Array< int > tmp33 = codes;		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(407)
					...
					HX_STACK_LINE(407)
					{
						...
						HX_STACK_LINE(407)
						int index = tmp35;		HX_STACK_VAR(index,"index");
						HX_STACK_LINE(407)
					...
					HX_STACK_LINE(407)
					int tmp35 = tmp33->__get(tmp34);		HX_STACK_VAR(tmp35,"tmp35");
					HX_STACK_LINE(407)
					int c4 = tmp35;		HX_STACK_VAR(c4,"c4");
					HX_STACK_LINE(408)
					{
						HX_STACK_LINE(408)
						int tmp36 = (bpos)++;		HX_STACK_VAR(tmp36,"tmp36");
						HX_STACK_LINE(408)
						int pos = tmp36;		HX_STACK_VAR(pos,"pos");
						HX_STACK_LINE(408)
						int tmp37 = (int(c3) << int((int)6));		HX_STACK_VAR(tmp37,"tmp37");
						HX_STACK_LINE(408)
						int tmp38 = c4;		HX_STACK_VAR(tmp38,"tmp38");
						HX_STACK_LINE(408)
				...
				HX_STACK_LINE(410)
				bool tmp22 = (rest >= (int)2);		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(410)
				if ((tmp22)){
					HX_STACK_LINE(411)
					Array< int > tmp23 = codes;		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(411)
					...
					HX_STACK_LINE(412)
					Array< int > tmp26 = codes;		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(412)
					...
					HX_STACK_LINE(412)
					int c2 = tmp28;		HX_STACK_VAR(c2,"c2");
					HX_STACK_LINE(413)
					{
						HX_STACK_LINE(413)
						...
						HX_STACK_LINE(413)
						int tmp30 = (int(c1) << int((int)2));		HX_STACK_VAR(tmp30,"tmp30");
						HX_STACK_LINE(413)
						int tmp31 = (int(c2) >> int((int)4));		HX_STACK_VAR(tmp31,"tmp31");
						HX_STACK_LINE(413)
					...
					HX_STACK_LINE(414)
					bool tmp29 = (rest == (int)3);		HX_STACK_VAR(tmp29,"tmp29");
					HX_STACK_LINE(414)
					if ((tmp29)){
						HX_STACK_LINE(415)
						Array< int > tmp30 = codes;		HX_STACK_VAR(tmp30,"tmp30");
				...
				hx::AddEq(this->pos,len);
				HX_STACK_LINE(421)
				cpp::ArrayBase tmp23 = this->cache;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(421)
				::haxe::io::Bytes tmp24 = bytes;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(421)
				tmp23->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp24);
				HX_STACK_LINE(422)
				::haxe::io::Bytes tmp25 = bytes;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(422)
				return tmp25;
			}
			;break;
			case (int)67: {
				...
				HX_STACK_LINE(431)
				bool tmp12 = (tmp11 != (int)103);		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(431)
				if ((tmp12)){
					HX_STACK_LINE(432)
...
Array< int > Unserializer_obj::initCodes( ){
	HX_STACK_FRAME("haxe.Unserializer","initCodes",0xee42ccdb,"haxe.Unserializer.initCodes","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",67,0xe71d5f2a)
	HX_STACK_LINE(72)
	...
	HX_STACK_LINE(74)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(75)
			Array< int > tmp4 = codes;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(75)
			::String tmp5 = ::haxe::Unserializer_obj::BASE64;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(75)
	...
	HX_STACK_LINE(76)
	Array< int > tmp = codes;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(76)
	return tmp;
}
...
Dynamic Unserializer_obj::run( ::String v){
	HX_STACK_FRAME("haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","/home/varomix/dev/Kha/Tools/haxe/std/haxe/Unserializer.hx",459,0xe71d5f2a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(460)
