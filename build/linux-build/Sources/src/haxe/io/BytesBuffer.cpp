...
{
HX_STACK_FRAME("haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesBuffer.hx",45,0x913ef8d3)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(54)
...
::haxe::io::Bytes BytesBuffer_obj::getBytes( ){
	HX_STACK_FRAME("haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesBuffer.hx",191,0x913ef8d3)
	HX_STACK_THIS(this)
	HX_STACK_LINE(212)
	...
	HX_STACK_LINE(212)
	::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::__new(tmp1,tmp2);		HX_STACK_VAR(bytes,"bytes");
	HX_STACK_LINE(214)
	this->b = null();
	HX_STACK_LINE(215)
