...
{
HX_STACK_FRAME("haxe.io.Bytes","new",0x3938d57d,"haxe.io.Bytes.new","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/Bytes.hx",36,0xfdcdb033)
HX_STACK_THIS(this)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/Bytes.hx",139,0xfdcdb033)
	HX_STACK_THIS(this)
...
::String Bytes_obj::getString( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/Bytes.hx",365,0xfdcdb033)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(367)
...
::String Bytes_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/Bytes.hx",424,0xfdcdb033)
	HX_STACK_THIS(this)
	HX_STACK_LINE(441)
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_FRAME("haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/Bytes.hx",463,0xfdcdb033)
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(473)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_FRAME("haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/Bytes.hx",490,0xfdcdb033)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(501)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(502)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_FRAME("haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/Bytes.hx",548,0xfdcdb033)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(558)
