...
{
HX_STACK_FRAME("haxe.io.BytesOutput","new",0x130b775e,"haxe.io.BytesOutput.new","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesOutput.hx",35,0xc4fb1d72)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(40)
...
{
		HX_STACK_FRAME("haxe.io.BytesOutput","writeByte",0xed1b0d05,"haxe.io.BytesOutput.writeByte","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesOutput.hx",55,0xc4fb1d72)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(55)
...
int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("haxe.io.BytesOutput","writeBytes",0x8a9057ce,"haxe.io.BytesOutput.writeBytes","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesOutput.hx",59,0xc4fb1d72)
	HX_STACK_THIS(this)
...
::haxe::io::Bytes BytesOutput_obj::getBytes( ){
	HX_STACK_FRAME("haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesOutput.hx",125,0xc4fb1d72)
	HX_STACK_THIS(this)
	HX_STACK_LINE(131)
	::haxe::io::BytesBuffer tmp = this->b;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(131)
