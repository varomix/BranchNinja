...
{
HX_STACK_FRAME("haxe.io.BytesInput","new",0x7fa18571,"haxe.io.BytesInput.new","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesInput.hx",38,0x8871877f)
HX_STACK_THIS(this)
HX_STACK_ARG(b,"b")
...
int BytesInput_obj::set_position( int p){
	HX_STACK_FRAME("haxe.io.BytesInput","set_position",0xafd318f5,"haxe.io.BytesInput.set_position","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesInput.hx",79,0x8871877f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p,"p")
	HX_STACK_LINE(80)
...
int BytesInput_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.BytesInput","readByte",0xb70e46cd,"haxe.io.BytesInput.readByte","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesInput.hx",90,0x8871877f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(94)
...
int BytesInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("haxe.io.BytesInput","readBytes",0x756fad06,"haxe.io.BytesInput.readBytes","/home/varomix/dev/Kha/Tools/haxe/std/haxe/io/BytesInput.hx",111,0x8871877f)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(146)
	Array< unsigned char > tmp12 = this->b;		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(146)
	Array< unsigned char > b1 = tmp12;		HX_STACK_VAR(b1,"b1");
	HX_STACK_LINE(147)
	...
	HX_STACK_LINE(148)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(149)
			Array< unsigned char > tmp16 = b2;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(149)
			int tmp17 = (pos + i);		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(149)
			Array< unsigned char > tmp18 = b1;		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(149)
			...
			HX_STACK_LINE(149)
			unsigned char tmp22 = tmp18->__get(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(149)
			tmp16[tmp17] = tmp22;
		}
	}
