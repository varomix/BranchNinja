...
{
		HX_STACK_FRAME("haxe.Utf8","iter",0x67f2370d,"haxe.Utf8.iter","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",55,0xa3c1de43)
		HX_STACK_ARG(s,"s")
...
int Utf8_obj::charCodeAt( ::String s,int index){
	HX_STACK_FRAME("haxe.Utf8","charCodeAt",0xce7cbeab,"haxe.Utf8.charCodeAt","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",61,0xa3c1de43)
	HX_STACK_ARG(s,"s")
...
int Utf8_obj::length( ::String s){
	HX_STACK_FRAME("haxe.Utf8","length",0x88322e1b,"haxe.Utf8.length","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",74,0xa3c1de43)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(75)
	Array< int > tmp = ::__hxcpp_utf8_string_to_char_array(s);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(75)
...
::String Utf8_obj::sub( ::String s,int pos,int len){
	HX_STACK_FRAME("haxe.Utf8","sub",0x67d06d2b,"haxe.Utf8.sub","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/haxe/Utf8.hx",91,0xa3c1de43)
	HX_STACK_ARG(s,"s")
