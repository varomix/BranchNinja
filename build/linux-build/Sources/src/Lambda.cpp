...
cpp::ArrayBase Lambda_obj::array( Dynamic it){
	HX_STACK_FRAME("Lambda","array",0x9c8b0512,"Lambda.array","/home/varomix/dev/Kha/Tools/haxe/std/Lambda.hx",42,0x725e7cf7)
	HX_STACK_ARG(it,"it")
	HX_STACK_LINE(43)
...
;
	...
	HX_STACK_LINE(46)
	cpp::ArrayBase tmp1 = a;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(46)
	return tmp1;
}
...
{
		HX_STACK_FRAME("Lambda","iter",0x9d877fbf,"Lambda.iter","/home/varomix/dev/Kha/Tools/haxe/std/Lambda.hx",170,0x725e7cf7)
		HX_STACK_ARG(it,"it")
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(171)
		Dynamic tmp = it->__Field(HX_HCSTRING("iterator","\xee","\x49","\x9a","\x93"), hx::paccDynamic )();		HX_STACK_VAR(tmp,"tmp");
