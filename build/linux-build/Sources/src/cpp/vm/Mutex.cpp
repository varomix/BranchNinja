...
{
HX_STACK_FRAME("cpp.vm.Mutex","new",0xabb3ca05,"cpp.vm.Mutex.new","/home/varomix/dev/Kha/Tools/haxe/std/cpp/vm/Mutex.hx",27,0xcdce62ab)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(28)
...
{
		HX_STACK_FRAME("cpp.vm.Mutex","acquire",0xc3527bfb,"cpp.vm.Mutex.acquire","/home/varomix/dev/Kha/Tools/haxe/std/cpp/vm/Mutex.hx",31,0xcdce62ab)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("cpp.vm.Mutex","release",0x675bb5ec,"cpp.vm.Mutex.release","/home/varomix/dev/Kha/Tools/haxe/std/cpp/vm/Mutex.hx",37,0xcdce62ab)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
