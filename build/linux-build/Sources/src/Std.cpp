...
bool Std_obj::is( Dynamic v,Dynamic t){
	HX_STACK_FRAME("Std","is",0x3c56d6f5,"Std.is","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Std.hx",23,0xbf502b3a)
	HX_STACK_ARG(v,"v")
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(24)
...
Dynamic Std_obj::instance( Dynamic value,::hx::Class c){
	HX_STACK_FRAME("Std","instance",0x1431f4e0,"Std.instance","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Std.hx",27,0xbf502b3a)
...
::String Std_obj::string( Dynamic s){
	HX_STACK_FRAME("Std","string",0xcf48855c,"Std.string","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Std.hx",31,0xbf502b3a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(32)
...
int Std_obj::_int( Float x){
	HX_STACK_FRAME("Std","int",0x8fa53b84,"Std.int","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Std.hx",35,0xbf502b3a)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(36)
...
Dynamic Std_obj::parseInt( ::String x){
	HX_STACK_FRAME("Std","parseInt",0x90c2ebc7,"Std.parseInt","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Std.hx",39,0xbf502b3a)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(40)
...
Float Std_obj::parseFloat( ::String x){
	HX_STACK_FRAME("Std","parseFloat",0xbca10a74,"Std.parseFloat","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Std.hx",43,0xbf502b3a)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(44)
...
int Std_obj::random( int x){
	HX_STACK_FRAME("Std","random",0x75a77e8e,"Std.random","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/Std.hx",47,0xbf502b3a)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(48)
