...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_FRAME("sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/sys/io/File.hx",32,0x96bc385a)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(33)
	::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(33)
	Array< unsigned char > tmp1 = ::sys::io::File_obj::file_contents(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(33)
	Array< unsigned char > data = tmp1;		HX_STACK_VAR(data,"data");
	HX_STACK_LINE(34)
	Array< unsigned char > tmp2 = data;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(34)
...
bool binary = __o_binary.Default(true);
	HX_STACK_FRAME("sys.io.File","read",0x203d07e1,"sys.io.File.read","/home/varomix/dev/Kha/Tools/haxe/std/cpp/_std/sys/io/File.hx",49,0x96bc385a)
	HX_STACK_ARG(path,"path")
