...
{
HX_STACK_FRAME("_List.ListIterator","new",0x1ee472af,"_List.ListIterator.new","/home/varomix/dev/Kha/Tools/haxe/std/List.hx",244,0x3f294c00)
HX_STACK_THIS(this)
...
bool ListIterator_obj::hasNext( ){
	HX_STACK_FRAME("_List.ListIterator","hasNext",0x25781b3c,"_List.ListIterator.hasNext","/home/varomix/dev/Kha/Tools/haxe/std/List.hx",249,0x3f294c00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(250)
	cpp::ArrayBase tmp = this->head;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(250)
...
Dynamic ListIterator_obj::next( ){
	HX_STACK_FRAME("_List.ListIterator","next",0xe8ffe7c4,"_List.ListIterator.next","/home/varomix/dev/Kha/Tools/haxe/std/List.hx",253,0x3f294c00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(254)
	cpp::ArrayBase tmp = this->head;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(254)
	Dynamic tmp1 = tmp->__GetItem((int)0);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(254)
	this->val = tmp1;
	HX_STACK_LINE(255)
	cpp::ArrayBase tmp2 = this->head;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(255)
	Dynamic tmp3 = tmp2->__GetItem((int)1);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(255)
	this->head = tmp3;
	HX_STACK_LINE(256)
	Dynamic tmp4 = this->val;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(256)
	return tmp4;
}
