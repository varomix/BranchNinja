...
{
HX_STACK_FRAME("List","new",0xed890070,"List.new","/home/varomix/dev/Kha/Tools/haxe/std/List.hx",41,0x3f294c00)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(41)
	this->length = (int)0;
...
{
		HX_STACK_FRAME("List","add",0xed7f2231,"List.add","/home/varomix/dev/Kha/Tools/haxe/std/List.hx",49,0x3f294c00)
		HX_STACK_THIS(this)
		HX_STACK_ARG(item,"item")
		HX_STACK_LINE(50)
		cpp::ArrayBase tmp = cpp::ArrayBase_obj::__new().Add(item);		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(50)
		cpp::ArrayBase x = tmp;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(51)
		cpp::ArrayBase tmp1 = this->h;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(51)
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(54)
			cpp::ArrayBase tmp3 = this->q;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(54)
			cpp::ArrayBase tmp4 = x;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(54)
			hx::IndexRef((tmp3).mPtr,(int)1) = tmp4;
		}
		HX_STACK_LINE(55)
		this->q = x;
		HX_STACK_LINE(56)
...
::_List::ListIterator List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","/home/varomix/dev/Kha/Tools/haxe/std/List.hx",161,0x3f294c00)
	HX_STACK_THIS(this)
	HX_STACK_LINE(162)
	cpp::ArrayBase tmp = this->h;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(162)
	::_List::ListIterator tmp1 = ::_List::ListIterator_obj::__new(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(162)
	return tmp1;
}
