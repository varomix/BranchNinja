...
class HXCPP_CLASS_ATTRIBUTES  Graphics_obj : public hx::Interface{
	public:
		...
		virtual Void begin( Array< ::kha::Canvas > additionalRenderTargets)=0;
...
virtual Dynamic scissor_dyn()=0;
		virtual Void disableScissor( )=0;
virtual Dynamic disableScissor_dyn()=0;
...
virtual Dynamic instancedRenderingAvailable_dyn()=0;
		virtual Void setPipeline( ::kha::graphics4::PipelineState pipeline)=0;
virtual Dynamic setPipeline_dyn()=0;
...
virtual Dynamic setInt_dyn()=0;
		virtual Void setFloat( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value)=0;
virtual Dynamic setFloat_dyn()=0;
		virtual Void setFloat2( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2)=0;
virtual Dynamic setFloat2_dyn()=0;
		virtual Void setFloat3( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2,::cpp::Float32 value3)=0;
virtual Dynamic setFloat3_dyn()=0;
		virtual Void setFloat4( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2,::cpp::Float32 value3,::cpp::Float32 value4)=0;
virtual Dynamic setFloat4_dyn()=0;
		virtual Void setFloats( ::kha::graphics4::ConstantLocation location,Array< ::cpp::Float32 > floats)=0;
virtual Dynamic setFloats_dyn()=0;
		virtual Void setVector2( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector2 value)=0;
virtual Dynamic setVector2_dyn()=0;
		virtual Void setVector3( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector3 value)=0;
virtual Dynamic setVector3_dyn()=0;
		virtual Void setVector4( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector4 value)=0;
virtual Dynamic setVector4_dyn()=0;
		virtual Void setMatrix( ::kha::graphics4::ConstantLocation location,::kha::math::FastMatrix4 value)=0;
...
class Graphics_delegate_ : public Graphics_obj
{
	...
	public:
		...
		Void begin( Array< ::kha::Canvas > additionalRenderTargets) { return mDelegate->begin(additionalRenderTargets);}
		...
		Void scissor( int x,int y,int width,int height) { return mDelegate->scissor(x,y,width,height);}
		Dynamic scissor_dyn() { return mDelegate->scissor_dyn();}
		Void disableScissor( ) { return mDelegate->disableScissor();}
		Dynamic disableScissor_dyn() { return mDelegate->disableScissor_dyn();}
		...
		Void setPipeline( ::kha::graphics4::PipelineState pipeline) { return mDelegate->setPipeline(pipeline);}
		Dynamic setPipeline_dyn() { return mDelegate->setPipeline_dyn();}
		...
		Void setFloat( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value) { return mDelegate->setFloat(location,value);}
		Dynamic setFloat_dyn() { return mDelegate->setFloat_dyn();}
		Void setFloat2( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2) { return mDelegate->setFloat2(location,value1,value2);}
		Dynamic setFloat2_dyn() { return mDelegate->setFloat2_dyn();}
		Void setFloat3( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2,::cpp::Float32 value3) { return mDelegate->setFloat3(location,value1,value2,value3);}
		Dynamic setFloat3_dyn() { return mDelegate->setFloat3_dyn();}
		Void setFloat4( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2,::cpp::Float32 value3,::cpp::Float32 value4) { return mDelegate->setFloat4(location,value1,value2,value3,value4);}
		Dynamic setFloat4_dyn() { return mDelegate->setFloat4_dyn();}
		Void setFloats( ::kha::graphics4::ConstantLocation location,Array< ::cpp::Float32 > floats) { return mDelegate->setFloats(location,floats);}
		Dynamic setFloats_dyn() { return mDelegate->setFloats_dyn();}
		Void setVector2( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector2 value) { return mDelegate->setVector2(location,value);}
		Dynamic setVector2_dyn() { return mDelegate->setVector2_dyn();}
		Void setVector3( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector3 value) { return mDelegate->setVector3(location,value);}
		Dynamic setVector3_dyn() { return mDelegate->setVector3_dyn();}
		Void setVector4( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector4 value) { return mDelegate->setVector4(location,value);}
		Dynamic setVector4_dyn() { return mDelegate->setVector4_dyn();}
		Void setMatrix( ::kha::graphics4::ConstantLocation location,::kha::math::FastMatrix4 value) { return mDelegate->setMatrix(location,value);}
