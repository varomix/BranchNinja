...
class HXCPP_CLASS_ATTRIBUTES  ColoredShaderPainter_obj : public hx::Object{
	...
	public:
		...
		virtual ::kha::graphics4::PipelineState set_pipeline( ::kha::graphics4::PipelineState pipe);
		Dynamic set_pipeline_dyn();

		virtual Void setProjection( ::kha::math::FastMatrix4 projectionMatrix);
		...
		virtual Void setRectColors( ::cpp::Float32 opacity,int color);
		...
		virtual Void setTriColors( ::cpp::Float32 opacity,int color);
		...
		virtual Void fillRect( ::cpp::Float32 opacity,int color,Float bottomleftx,Float bottomlefty,Float topleftx,Float toplefty,Float toprightx,Float toprighty,Float bottomrightx,Float bottomrighty);
		Dynamic fillRect_dyn();

		virtual Void fillTriangle( ::cpp::Float32 opacity,int color,Float x1,Float y1,Float x2,Float y2,Float x3,Float y3);
