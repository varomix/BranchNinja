...
class HXCPP_CLASS_ATTRIBUTES  Graphics_obj : public hx::Object{
	...
	public:
		...
		virtual Void setStencilParameters2( int compareMode,int bothPass,int depthFail,int stencilFail,int referenceValue,int readMask,int writeMask);
		...
		virtual Void setPipeline( ::kha::graphics4::PipelineState pipe);
		...
		virtual Void setFloat( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value);
		Dynamic setFloat_dyn();

		virtual Void setFloatPrivate( ::kha::kore::graphics4::ConstantLocation location,::cpp::Float32 value);
		Dynamic setFloatPrivate_dyn();

		virtual Void setFloat2( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2);
		Dynamic setFloat2_dyn();

		virtual Void setFloat2Private( ::kha::kore::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2);
		Dynamic setFloat2Private_dyn();

		virtual Void setFloat3( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2,::cpp::Float32 value3);
		Dynamic setFloat3_dyn();

		virtual Void setFloat3Private( ::kha::kore::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2,::cpp::Float32 value3);
		Dynamic setFloat3Private_dyn();

		virtual Void setFloat4( ::kha::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2,::cpp::Float32 value3,::cpp::Float32 value4);
		Dynamic setFloat4_dyn();

		virtual Void setFloat4Private( ::kha::kore::graphics4::ConstantLocation location,::cpp::Float32 value1,::cpp::Float32 value2,::cpp::Float32 value3,::cpp::Float32 value4);
		Dynamic setFloat4Private_dyn();

		virtual Void setVector2( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector2 value);
		Dynamic setVector2_dyn();

		virtual Void setVector2Private( ::kha::kore::graphics4::ConstantLocation location,::cpp::Float32 x,::cpp::Float32 y);
		Dynamic setVector2Private_dyn();

		virtual Void setVector3( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector3 value);
		Dynamic setVector3_dyn();

		virtual Void setVector3Private( ::kha::kore::graphics4::ConstantLocation location,::cpp::Float32 x,::cpp::Float32 y,::cpp::Float32 z);
		Dynamic setVector3Private_dyn();

		virtual Void setVector4( ::kha::graphics4::ConstantLocation location,::kha::math::FastVector4 value);
		Dynamic setVector4_dyn();

		virtual Void setVector4Private( ::kha::kore::graphics4::ConstantLocation location,::cpp::Float32 x,::cpp::Float32 y,::cpp::Float32 z,::cpp::Float32 w);
		Dynamic setVector4Private_dyn();

		virtual Void setFloats( ::kha::graphics4::ConstantLocation location,Array< ::cpp::Float32 > values);
		Dynamic setFloats_dyn();

		virtual Void setFloatsPrivate( ::kha::kore::graphics4::ConstantLocation location,Array< ::cpp::Float32 > values);
		Dynamic setFloatsPrivate_dyn();

		virtual Void setMatrix( ::kha::graphics4::ConstantLocation location,::kha::math::FastMatrix4 matrix);
		...
		virtual Void begin( Array< ::kha::Canvas > additionalRenderTargets);
		Dynamic begin_dyn();
