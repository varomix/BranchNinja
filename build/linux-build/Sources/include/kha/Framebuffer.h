...
class HXCPP_CLASS_ATTRIBUTES  Framebuffer_obj : public hx::Object{
	public:
		...
		Framebuffer_obj();
		Void __construct(int windowId,::kha::graphics1::Graphics g1,::kha::graphics2::Graphics g2,::kha::graphics4::Graphics g4);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="kha.Framebuffer")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< Framebuffer_obj > __new(int windowId,::kha::graphics1::Graphics g1,::kha::graphics2::Graphics g2,::kha::graphics4::Graphics g4);
