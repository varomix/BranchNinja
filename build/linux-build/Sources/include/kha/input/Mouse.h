...
class HXCPP_CLASS_ATTRIBUTES  Mouse_obj : public ::kha::network::Controller_obj{
	...
	public:
		...
		virtual Void notifyWindowed( int windowId,Dynamic downListener,Dynamic upListener,Dynamic moveListener,Dynamic wheelListener);
		Dynamic notifyWindowed_dyn();

		virtual Void removeWindowed( int windowId,Dynamic downListener,Dynamic upListener,Dynamic moveListener,Dynamic wheelListener);
		...
		virtual Void notifyOnLockChange( Dynamic func,Dynamic error);
		...
		virtual Void sendDownEvent( int windowId,int button,int x,int y);
		Dynamic sendDownEvent_dyn();

		virtual Void sendUpEvent( int windowId,int button,int x,int y);
		Dynamic sendUpEvent_dyn();

		virtual Void sendMoveEvent( int windowId,int x,int y,int movementX,int movementY);
		Dynamic sendMoveEvent_dyn();

		virtual Void sendWheelEvent( int windowId,int delta);
