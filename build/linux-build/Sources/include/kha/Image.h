...
class HXCPP_CLASS_ATTRIBUTES  Image_obj : public hx::Object{
	...
	public:
		...
		virtual Void initRenderTarget( int width,int height,int depthBufferBits,int format,int stencilBufferBits,int contextId);
		...
		virtual Void generateMipmaps( int levels);
		Dynamic generateMipmaps_dyn();

		virtual Void setMipmaps( Array< ::Dynamic > mipmaps);
